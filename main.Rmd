...
```{r}
df$DELAIDEM = df$AGEDEM6-df$AGE0
shatter$DELAIDEM = shatter$AGEDEM6-df$AGE0

shatter_j = shatter[shatter$DELAIDEM>=shatter$DELAI,]
df_j = df[df$DELAIDEM >= df$DELAI,]

modelsurv = coxph(Surv(DELAIDEM, DEM0_6==1)~ SOM
                                          + SEXE
                                          + AGE0
                                          + factor(CENTRE)
                                          + factor(ETUDE_CLAS0)
...
model_j = lme(fixed = LOGCESDT ~ DELAI*(factor(CENTRE)
                                          + ETUDE_CLAS0
                                          + SEXE
                                          + ANTIDEP0
                                          + AGECENTER
